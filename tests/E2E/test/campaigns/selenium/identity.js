    ...
    scenario('The Customer Identity Page', client => {
        test('should show the customer form', () => {
            return promise
                ...
                .then(() => client.waitAndSetValue(accountPage.signin_email_input, "hello@wepika.com"))
                .then(() => client.waitAndSetValue(accountPage.signin_password_input, "wesxk@$pi"))
        ...
        test('should refuse to save the customer if the wrong password is provided', () => {
            return promise
                ...
                // Ca veut pas cliquer la checkbox
                .then(() => {
                    client.waitForExistAndClick(accountPage.psgdpr_button);
                    client.checkAttributeValue(accountPage, "value", "1");
                })
        ...
        test('should save the customer if the correct password is provided', () => {
            return promise
                .then(() => client.waitAndSetValue(accountPage.password_account_input, "wesxk@$pi"))
        ...
        test('should allow the customer to use the new password', () => {
            return promise
                ...
                .then(() => client.waitAndSetValue(accountPage.new_password_input, "wesxk@$pi"))
                .then(() => client.waitForExistAndClick(accountPage.save_account_button))
                .then(() => client.waitForVisible(accountPage.success_alert));
        });
        test('should logout', () => {
