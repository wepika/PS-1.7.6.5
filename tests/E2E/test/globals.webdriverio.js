...
let siteUrl = argv.URL || 'http://localhost/sandbox/1.7.6.5/'
...
global.adminEmail = argv.ADMIN_EMAIL || 'hello@wepika.com';
global.adminPassword = argv.ADMIN_PASSWORD || 'wesxk@$pi';
